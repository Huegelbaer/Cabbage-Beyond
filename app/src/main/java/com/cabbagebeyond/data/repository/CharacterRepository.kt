...
fun CharacterWithEverything.asDomainModel(): Character {
    return Character(
        ...
        character.parry,
        character.toughness,
        abilities.map { it.asDomainModel(world) },
        equipments.map { it.asDomainModel(world) },
        forces.map { it.asDomainModel(world) },
        handicaps.map { it.asDomainModel(world) },
        talents.map { it.asDomainModel(world) },
